...
import {
  ArrowRight, Bot, Globe, ShoppingCart, Phone, LayoutDashboard,
  Database, BrainCircuit, Rocket, Store, Building2, MessageCircle,
  Scissors, Headset,
} from "lucide-react";
      ...
      <main className="ww-root grain-bg min-h-screen">
        ...
        <section className="px-5 sm:px-8 pt-14 sm:pt-20 pb-12 sm:pb-16">
          <div className="max-w-[1200px] mx-auto">
            ...
            <h1 className="font-display leading-[0.98] font-medium text-[38px] sm:text-[56px] lg:text-[64px] max-w-3xl">
              Whatever's eating your time,
              <span className="block italic text-[var(--terracotta)] mt-1">
                we've probably automated it
              </span>
            </h1>

            <p className="mt-6 max-w-2xl text-[var(--muted)] text-base sm:text-lg leading-[1.75]">
              Twelve common starting points below — but most projects end up
              combining two or three of these. Not sure which one fits? Tell
              us your situation on a free call and we'll point you to the
              right one.
            </p>
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-5 sm:p-6 flex flex-col">
                      ...
                      <p className="mt-4 text-[var(--muted)] text-sm leading-relaxed">{service.desc}</p>
                      ...
                      <div className="mt-5 flex items-center justify-between rounded-[3px] border border-[var(--line)] bg-[var(--cream)] px-4 py-3 group-hover:bg-[var(--terracotta-tint)] group-hover:border-[var(--terracotta)] transition-all duration-200">
                        <span className="text-sm font-semibold text-[var(--ink)]">Get a quote for this</span>
        ...
        <section className="px-5 sm:px-8 pb-16 sm:pb-24">
          <div className="max-w-[1200px] mx-auto card p-8 sm:p-14 text-center">
            <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-medium leading-tight">
              Most clients combine
              <span className="italic text-[var(--terracotta)]"> two or three of these</span>
            </h2>

            <p className="mt-5 text-[var(--muted)] max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
              A website without follow-up automation just sits there. We'll
              help you figure out the combination that actually moves
              revenue — on a free call, no pitch deck required.
            </p>

            <a href={CALENDLY_URL} target="_blank" rel="noreferrer" className="btn-primary inline-flex mt-9">
              Book a free call
              <ArrowRight className="w-4 h-4" />
            </a>
          </div>
